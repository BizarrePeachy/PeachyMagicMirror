...
Module.register("compliments", {
	...
	defaults: {
		compliments: {
			anytime: ["Hey, David!"],
			morning: ["Good morning gang!", "Enjoy your day!", "How was your sleep?"],
			afternoon: ["How was school?", "You look tired...", "Looking good today!"],
			cloudy: ["It's cloudy today!", "You should probably take an umbrella.", "It might rain today."],
			showers: ["It's raining!", "You should probably wear a raincoat.", "You should probably take an umbrella."],
			fog: ["It's foggy today!", "Lower visability!", "You should probably wear a mask."],
			evening: ["How was your day?", "You look nice!", "Hi, David!", "What's the plan?"],
			day_sunny: ["Oh cool I can see the sun!", "It's pretty nice outside!", "It's blazing out there!", "You should probably just wear a shirt", "No hoodie today :<"],
			thunderstorm: ["ITS THUNDERINGGG YAAAAY!"],
			night_clear: ["LATE NIGHT GRINDINGGG", "You should really go to bed ngl lol"],
			night_showers: ["LAGGY LATE NIGHT GRINDINGGG"],
